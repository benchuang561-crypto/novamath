        ...
        lessons: [
          {
            ...
            practice: [
              ...
              { q: "Evaluate 6x-4 when x=2", a: "8", h: "6(2)-4" },
              { q: "Evaluate 2a+3b when a=3, b=2", a: "12", h: "2(3)+3(2)" },
              { q: "Evaluate (x+y)² when x=3, y=1", a: "16", h: "(3+1)² = 4²" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Simplify: 5×2+3²", a: "19", h: "5×2+9 = 10+9" },
              { q: "Simplify: 20÷(4+1)×3", a: "12", h: "20÷5×3 = 4×3" },
              { q: "Simplify: 4+3²×2", a: "22", h: "Exponent: 9×2=18, 4+18" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Simplify: 3(x+2y)-2(x-y)", a: "x+8y", alt: ["x + 8y"], h: "3x+6y-2x+2y" },
              { q: "Factor out 5: 5x+15", a: "5(x+3)", alt: ["5(x + 3)"], h: "Divide both terms by 5" }
            ]
          }
        ]
      },
        ...
        lessons: [
          {
            ...
            practice: [
              ...
              { q: "Solve: x/4=5", a: "20", h: "Multiply both sides by 4" },
              { q: "Solve: 6x=42", a: "7", h: "Divide both sides by 6" },
              { q: "Solve: x-9=15", a: "24", h: "Add 9 to both sides" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Solve: 4x+3=19", a: "4", h: "Subtract 3, divide by 4" },
              { q: "Solve: x/5-2=3", a: "25", h: "Add 2, multiply by 5" },
              { q: "Solve: 7x-10=32", a: "6", h: "Add 10, divide by 7" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Solve: 3(x+4)-x=16", a: "2", h: "3x+12-x=16 → 2x=4" },
              { q: "Solve: 2(x-3)+4x=18", a: "4", h: "2x-6+4x=18 → 6x=24" },
              { q: "Solve: 5x-2(x+1)=10", a: "4", h: "5x-2x-2=10 → 3x=12" }
            ]
          }
        ]
      },
        ...
        lessons: [
          {
            ...
            practice: [
              ...
              { q: "Find slope through (-2,1) and (2,9)", a: "2", h: "(9-1)/(2-(-2)) = 8/4" },
              { q: "Find slope of 4x-2y=8", a: "2", h: "Solve for y: -2y=-4x+8 → y=2x-4" },
              { q: "Find slope through (0,-3) and (5,2)", a: "1", h: "(2-(-3))/(5-0) = 5/5" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Find slope and y-intercept of y=-3x+5", a: "m=-3,b=5", alt: ["-3,5"], h: "Compare to y=mx+b" },
              { q: "Write equation with slope -1/2, y-intercept 3", a: "y=-0.5x+3", alt: ["y=-1/2x+3", "y = -0.5x + 3"], h: "y=mx+b" },
              { q: "Find x-intercept of y=2x-6", a: "3", h: "Set y=0: 0=2x-6 → 2x=6" }
            ]
          }
        ]
      }
        ...
        lessons: [
          {
            ...
            practice: [
              ...
              { q: "Solve: x²-4x=0", a: "0,4", alt: ["4,0"], h: "Factor: x(x-4)=0" },
              { q: "Solve: 2x²-8=0", a: "2,-2", alt: ["-2,2", "±2"], h: "x²=4" },
              { q: "Factor: x²-6x+9", a: "(x-3)²", alt: ["(x-3)^2"], h: "Perfect square trinomial" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Solve: x²-6x+8=0", a: "2,4", alt: ["4,2"], h: "a=1,b=-6,c=8. x=(6±√4)/2" },
              { q: "Find discriminant of 2x²+3x-2=0", a: "25", h: "b²-4ac = 9-4(2)(-2) = 9+16" },
              { q: "Solve: 3x²-12=0", a: "2,-2", alt: ["-2,2"], h: "x²=4" }
            ]
          },
          {
            title: "Vertex Form",
            ...
            practice: [
              ...
              { q: "Find vertex of y=-(x+2)²+5", a: "(-2,5)", alt: ["-2,5"], h: "h=-2, k=5" },
              { q: "Convert to vertex: y=x²-6x+10", a: "y=(x-3)²+1", alt: ["y=(x-3)^2+1"], h: "Complete square: x²-6x+9+1" },
              { q: "Find axis of symmetry: y=3(x-4)²-2", a: "x=4", alt: ["4"], h: "x=h" }
            ]
          }
        ]
      },
        ...
        lessons: [
          {
            ...
            practice: [
              ...
              { q: "Multiply: (x+2)(x-3)", a: "x²-x-6", alt: ["x^2-x-6"], h: "FOIL: x²-3x+2x-6" },
              { q: "Find degree: 5x³-2x+7", a: "3", h: "Highest power is 3" },
              { q: "Expand: (x-4)²", a: "x²-8x+16", alt: ["x^2-8x+16"], h: "x²-4x-4x+16" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Is (x-2) a factor of x²-5x+6?", a: "yes", alt: ["Yes"], h: "Check if x=2 is a root: 4-10+6=0" },
              { q: "Divide 2x²+5x+2 by (x+2)", a: "2x+1", alt: ["2x + 1"], h: "Use polynomial long division" },
              { q: "Divide x²-5x+6 by (x-2)", a: "x-3", alt: ["x - 3"], h: "(x-2)(x-3)" },
              { q: "Is (x+1) a factor of x²-1?", a: "yes", alt: ["Yes"], h: "Plug in x=-1: 1-1=0" }
            ]
          }
        ]
      },
        ...
        lessons: [
          {
            ...
            practice: [
              ...
              { q: "Solve: 3^x=27", a: "3", h: "27=3³" },
              { q: "Evaluate: 10⁻¹", a: "0.1", alt: ["1/10"], h: "1/10¹" },
              { q: "Solve: 4^x=64", a: "3", h: "4³=64" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Evaluate: log₄(64)", a: "3", h: "4³=64" },
              { q: "Solve: log₅(x)=2", a: "25", h: "x=5²" },
              { q: "Evaluate: log₇(49)", a: "2", h: "7²=49" }
            ]
          }
        ]
      }
        ...
        lessons: [
          {
            ...
            practice: [
              ...
              { q: "What is formed when two lines intersect?", a: "point", alt: ["Point"], h: "Lines cross at exactly one point" },
              { q: "True or False: Parallel lines never intersect", a: "true", alt: ["True"], h: "By definition" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Two angles are supplementary. One is 100°. Find the other.", a: "80", h: "180-100" },
              { q: "An angle is 20° more than its supplement. Find the angle.", a: "100", h: "x+(x+20)=180 → 2x=160" }
            ]
          }
        ]
      },
        ...
        lessons: [
          {
            ...
            practice: [
              ...
              { q: "Find third angle: 90°, 40°, ?", a: "50", h: "180-90-40" },
              { q: "Exterior angle is 120°. Remote interiors are 50° and ?", a: "70", h: "120-50" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Find leg: hypotenuse 15, one leg 9", a: "12", h: "√(225-81)=√144" },
              { q: "Is 5-12-13 a right triangle?", a: "yes", alt: ["Yes"], h: "25+144=169" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "In 30-60-90, long leg=6√3, find short leg", a: "6", h: "Long leg = short leg×√3" },
              { q: "In 45-45-90, leg=8, find hypotenuse", a: "8√2", alt: ["8sqrt2", "11.31"], h: "leg×√2" }
            ]
          }
        ]
      },
        ...
        lessons: [
          {
            ...
            practice: [
              ...
              { q: "Find diameter: radius=9", a: "18", h: "d=2r" },
              { q: "Find circumference: d=10", a: "10π", alt: ["10pi", "31.4"], h: "C=πd" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Find sector area: r=3, angle=120°", a: "3π", alt: ["3pi", "9.42"], h: "(120/360)×π(9) = (1/3)×9π" },
              { q: "Find central angle: arc length=5π, r=10", a: "90", h: "5π=(θ/360)×20π → θ/360=1/4" }
            ]
          }
        ]
      }
        ...
        lessons: [
          {
            ...
            practice: [
              ...
              { q: "cos(90°)=?", a: "0", h: "At 90°, point is (0,1)" },
              { q: "tan(30°)=?", a: "√3/3", alt: ["sqrt3/3", "1/√3", "0.577"], h: "sin/cos = (1/2)/(√3/2)" },
              { q: "sin(180°)=?", a: "0", h: "Point is (-1,0), y=0" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "If sin(θ)=4/5, find tan(θ) (Q1)", a: "4/3", alt: ["1.333"], h: "opp=4, hyp=5, adj=3" },
              { q: "Simplify: sec²(x)-tan²(x)", a: "1", h: "1+tan²=sec² → sec²-tan²=1" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Solve: sin(x)=-1 (0°≤x<360°)", a: "270", h: "sin is -1 at 270°" },
              { q: "Solve: cos(x)=-1/2 (0°≤x<360°)", a: "120,240", alt: ["120°,240°"], h: "cos is negative in Q2 and Q3" }
            ]
          }
        ]
      },
        ...
        lessons: [
          {
            ...
            practice: [
              ...
              { q: "Multiply: (1+2i)(3-i)", a: "5+5i", alt: ["5 + 5i"], h: "3-i+6i-2i² = 3+5i+2" },
              { q: "Find modulus of: 3+4i", a: "5", h: "√(3²+4²)=√25" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Find conjugate of: 4-3i", a: "4+3i", alt: ["4 + 3i"], h: "Flip the sign of b" },
              { q: "Multiply: (1+i)(1-i)", a: "2", h: "1²+1²=2" }
            ]
          }
        ]
      },
        ...
        lessons: [
          {
            ...
            practice: [
              ...
              { q: "Find common difference: 10,7,4,1", a: "-3", h: "7-10" },
              { q: "Sum first 6 terms: 3,6,9,12,15,18", a: "63", h: "S₆=6/2(3+18)" }
            ]
          },
          {
            ...
            practice: [
              ...
              { q: "Find common ratio: 10,20,40,80", a: "2", h: "20/10" },
              { q: "Sum infinite series: 8, 4, 2, 1...", a: "16", h: "a/(1-r) = 8/(1-0.5)" }
            ]
          }
        ]
      }
...
const mixedPracticePool = [
  ...
  // NEW MIXED PROBLEMS
  { q: "Solve: 3x+4=16", a: "4", course: "algebra1" },
  { q: "Find vertex: y=(x-2)²+3", a: "(2,3)", alt: ["2,3"], course: "algebra2" },
  { q: "Find complement of 45°", a: "45", course: "geometry" },
  { q: "cos(90°)=?", a: "0", course: "precalculus" },
  { q: "Simplify: 5×2+3²", a: "19", course: "algebra1" },
  { q: "Solve: x²-4x=0", a: "0,4", alt: ["4,0"], course: "algebra2" },
  { q: "Find area: r=5", a: "25π", alt: ["25pi"], course: "geometry" },
  { q: "tan(45°)=?", a: "1", course: "precalculus" },
  { q: "Solve: x/4=5", a: "20", course: "algebra1" },
  { q: "Find discriminant of x²+3x+2=0", a: "1", course: "algebra2" },
  { q: "Find leg: hypotenuse 10, leg 6", a: "8", course: "geometry" },
  { q: "sin(90°)=?", a: "1", course: "precalculus" },
  { q: "Evaluate 6x-4 when x=2", a: "8", course: "algebra1" },
  { q: "Simplify: 2⁴×2³", a: "128", course: "algebra2" },
  { q: "Find common ratio: 27,9,3,1", a: "1/3", alt: ["0.333"], course: "precalculus" },
  { q: "Find sum of first 5 terms: 1,3,5,7,9", a: "25", course: "precalculus" }
];
...
function getProblemsForTopic(topic) {
  ...
  course.units.forEach(unit => {
    unit.lessons.forEach(lesson => {
      if (lesson.practice) lesson.practice.forEach(p => problems.push({ ...p, course: topic }));
    });
  });
  return problems;
}
...
function checkIndexAnswer() {
  ...
  if (isCorrect) {
    ...
    feedbackEl.innerHTML = '✓ Correct! Click "Check" or press Enter for next problem.';
